...
#define SUITE_FUNCS                                                             \
  (Suite * (*[])(void)) {                                                       \
    s21_add_suite, s21_mul_suite, s21_sub_suite, s21_div_suite, s21_mod_suite,  \
        ...
        s21_truncate_suite, s21_negate_suite, s21_floor_suite, s21_round_suite, \
        s21_is_greater_suite, s21_is_equal_suite, s21_is_greater_or_equal_suite,\
        s21_is_less_suite, s21_is_less_or_equal_suite, s21_is_not_equal_suite  \
}
