...
START_TEST(test_01_s21_add) {
  s21_decimal a = {{123, 0, 0, 0x00050000}}, 
              b = {{456, 0, 0, 0x00050000}},
              c = {{579, 0, 0, 0x00050000}},
              res = DECIMAL_ZERO;
...
START_TEST(test_02_s21_add) {
  s21_decimal a = {{123, 0, 0, 0x80050000}},
              b = {{456, 0, 0, 0x00050000}},
              c = {{333, 0, 0, 0x00050000}},
              res = DECIMAL_ZERO;
...
START_TEST(test_03_s21_add) {
  s21_decimal a = {{555, 0, 0, 0x80050000}},
              b = {{456, 0, 0, 0x00050000}},
              c = {{99, 0, 0, 0x80050000}},
              res = DECIMAL_ZERO;
...
START_TEST(test_04_s21_add) {
  s21_decimal a = {{123, 0, 0, 0x00050000}},
              b = {{456, 0, 0, 0x80050000}},
              c = {{333, 0, 0, 0x80050000}},
              res = DECIMAL_ZERO;
...
START_TEST(test_05_s21_add) {
  s21_decimal a = {{555, 0, 0, 0x00050000}},
              b = {{456, 0, 0, 0x80050000}},
              c = {{99, 0, 0, 0x00050000}},
              res = DECIMAL_ZERO;
...
START_TEST(test_06_s21_add) {
  s21_decimal a = {{555, 55, 0, 0x00050000}},
              b = {{456, 55, 0, 0x80050000}},
              c = {{99, 0, 0, 0x00050000}},
              res = DECIMAL_ZERO;
