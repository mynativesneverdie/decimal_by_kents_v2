...
START_TEST(s21_trun_2) {
    s21_decimal dec1;
    dec1.bits[0] = 0b11111111111111111111111111111111;  // 79228162514264337593543950335
    dec1.bits[1] = 0b11111111111111111111111111111111;
    dec1.bits[2] = 0b11111111111111111111111111111111;
    dec1.bits[3] = 0b00000000000000010000000000000000;
    s21_decimal result;
    result.bits[0] = 0b10011001100110011001100110011001; // 7922816251426433759354395033.5
...
START_TEST(s21_truncate_1) {
    ...
    dec1.bits[0] = 0xFFFFFFFF; //  1844674407.3709551615
...
START_TEST(s21_truncateTest10) {
  s21_decimal value = {{UINT_MAX, UINT_MAX, UINT_MAX, 0xFFFF0000 }};
  s21_decimal result = {{0, 0, 0, 0}};
