...
int s21_is_less_or_equal_simple(s21_decimal value_1, s21_decimal value_2) {
  return s21_is_less_simple(value_1, value_2) || s21_is_equal_simple(value_1, value_2);
}
...
int s21_is_greater_or_equal_simple(s21_decimal value_1, s21_decimal value_2) {
  return s21_is_greater_simple(value_1, value_2) || s21_is_equal_simple(value_1, value_2);
}
